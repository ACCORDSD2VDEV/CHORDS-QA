...
tab7.11_combined <- tab7.11_rowCnt

tab7.11_combined$rowPct <- round(100*(tab7.11_combined$missingRowCnt/tab7.11_combined$rowCnt),1)
tab7.11_combined$year <- as.character(tab7.11_combined$year)
```

```{r tab7.11_disp, echo = F, include=T}
knitr::kable(tab7.11_combined[    c('year', 'missingRowCnt','rowCnt','rowPct')], 
